const debug = require('debug')('alodi:buildapi');
const debug2 = require('debug')('alodi:postFix');
const debug3 = require('debug')('alodi:error');
const debug4 = require('debug')('alodi:pureXs');
const debug5 = require('debug')('alodi:collectMocks');
const debug6 = require('debug')('alodi:collectResponseMocks');
